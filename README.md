...
> **项目状态（2026 年 9 月 7 日）**：本项目暂时停止维护。由于当前没有足够的时间继续投入，暂时不会承诺新功能、Bug 修复、新版 Windows 兼容性适配或对 Issue/PR 的及时响应。
>
> 现有代码仍可按当前状态自行使用、Fork 和修改，请根据自己的网络环境验证行为。详见[停更说明 Issue #2](https://github.com/7oMB2006/PPPoE-Guardian/issues/2)；如后续恢复维护，会更新 README 和该 Issue。
